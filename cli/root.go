// Package cli builds the pydocs command tree on top of the pydocs library.
package cli
...
// ExitError carries a numeric exit code alongside an optional wrapped error.
...
func Root() *cobra.Command {
	app := &App{cfg: pydocs.DefaultConfig()}

	root := &cobra.Command{
		Use:           "pydocs",
		Short:         "Browse Python standard library documentation",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = pydocs.NewClient(a.cfg)
	return nil
}
