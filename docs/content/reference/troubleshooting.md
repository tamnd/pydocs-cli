...
Most of these come down to network reality or how pydocs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pydocs rate-limits like any public site. pydocs already paces
...
Where a surface is gated, pydocs reads a cookie or token you supply
...
`pydocs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pydocs actually did
